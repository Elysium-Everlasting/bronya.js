...
Based off [CAC](https://github.com/cacjs/cac)
...
Use CLI as simple argument parser:

```js
// examples/basic-usage.js
const cli = require('@bronya.js/cli')()
...
> TODO: The type parsing doesn't support this yet.
...
```js
const { createCLI } = require('@bronya.js')
// OR ES modules
...
CLI instance is created by invoking the `createCLI` function:

```js
const createCLI = require('@bronya.js/cli')
const cli = createCLI()
```
...
type ActionCallback = (
  ...
  args: {
    [k: string]: string | string[] | number | number[]
  }
